...
public interface MyDslPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute list '{@link org.xtext.example.mydsl.myDsl.Model#getValues <em>Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Values</em>'.
   * @see org.xtext.example.mydsl.myDsl.Model#getValues()
   * @see #getModel()
   * @generated
   */
